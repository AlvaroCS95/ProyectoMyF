...
public class IngresoFacturaCompra extends javax.swing.JPanel {
    ...
    public void VerificarTipoPago() { // opcional, el hp metodo no me funcionó

        if (cbxTipoPago_FacturaCompra.getSelectedItem() == "Efectivo") {
    ...
    public boolean VerificarCamposVacios() {
        ...
        if (txtNumeroDeFactura_IngresarFacturaCompra.getText().isEmpty()) {
        ...
        } else if (txtN_Pedido.getText().isEmpty()) {
            
            mensaje += "\n¡Debe ingresar el numero de pedido!";
        } else if (txtN_Entrega.getText().isEmpty()) {
            
            mensaje += "\n¡Debe ingresar el numero de entrega!";
        } else if ((cbxTipoPago_FacturaCompra.getSelectedItem() != "Efectivo")
            ...
            mensaje += "\n¡Debe ingresar el numero de referencia!";
                ...
                || txtMontoCancelado_IngresarFacturaCompra.getText().isEmpty()
                || txtPlazoDias_IngresarFacturaCompra.getText().isEmpty()) {
    ...
    private void initComponents() {
        ...
        btAceptar_IngresarFacturaCompra = new javax.swing.JButton();
        ...
        panel_IngreosFacturaCompra.setPreferredSize(new java.awt.Dimension(980, 1100));
        ...
        btAceptar_IngresarFacturaCompra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Check_Icon_32.png"))); // NOI18N
        btAceptar_IngresarFacturaCompra.setToolTipText("Oprima para cancelar");
        btAceptar_IngresarFacturaCompra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btAceptar_IngresarFacturaCompraActionPerformed(evt);
            }
        });
        panel_IngreosFacturaCompra.add(btAceptar_IngresarFacturaCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 1050, -1, -1));
        ...
        panel_IngreosFacturaCompra.add(btLimpiar_IngresarFacturaCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 1050, -1, -1));
        ...
        panel_IngreosFacturaCompra.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 670, 510, -1));
    ...
    private void btAceptar_IngresarFacturaCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptar_IngresarFacturaCompraActionPerformed
        IngresarFacturaCompra();
    }//GEN-LAST:event_btAceptar_IngresarFacturaCompraActionPerformed
