 ...
 * @author Christian
 */
public class GestorDeImpresion  implements Printable{
 public static String TextoAImprimir="";
 

    public GestorDeImpresion(String TextoAImprimir) {
        this.TextoAImprimir+=TextoAImprimir;
    }
    
   public String PieDePagina="\t\t  Distribuidora MyF\n"
...
//Se obtienen las lineas de texto del JTextArea, la linea de texto finaliza cuando se encuentra el caracter de nueva linea \n
       StringTokenizer lineasdetexto = new StringTokenizer(PieDePagina+"\n"+TextoAImprimir, "\n", true);
       //Se obtiene el total de lineas de texto
       int totallineas = lineasdetexto.countTokens();

    int[] paginas;  // Arreglo de n̼mero de paginas que se necesitaran para imprimir todo el texto 
